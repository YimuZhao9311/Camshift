...
while True:
    ...
    cv2.putText(vis, 'Fused Result', (fused_center[0]+10, fused_center[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0,255,255), 1)
    cv2.putText(vis, f'FPS: {fps:.2f}', (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,255,0), 2)  
